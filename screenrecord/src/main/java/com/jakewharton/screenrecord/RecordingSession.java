...
final class RecordingSession {
  ...
  private void showNotification(final Uri uri, Bitmap bitmap) {
    ...
    CharSequence title = context.getText(com.jakewharton.screenrecord.R.string.notification_captured_title);
    CharSequence subtitle = context.getText(com.jakewharton.screenrecord.R.string.notification_captured_subtitle);
    CharSequence share = context.getText(com.jakewharton.screenrecord.R.string.notification_captured_share);
    CharSequence delete = context.getText(com.jakewharton.screenrecord.R.string.notification_captured_delete);
    Notification.Builder builder = new Notification.Builder(context) //
        ...
        .setColor(context.getResources().getColor(com.jakewharton.screenrecord.R.color.primary_normal))
        .setContentIntent(pendingViewIntent)
        .setAutoCancel(true)
        .addAction(com.jakewharton.screenrecord.R.drawable.ic_share_white_24dp, share, pendingShareIntent)
        .addAction(com.jakewharton.screenrecord.R.drawable.ic_delete_white_24dp, delete, pendingDeleteIntent);
