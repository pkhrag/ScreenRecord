...
final class OverlayView extends FrameLayout {
  ...
  static WindowManager.LayoutParams createLayoutParams(Context context) {
    int width = context.getResources().getDimensionPixelSize(com.jakewharton.screenrecord.R.dimen.overlay_width);
  ...
  @BindView(com.jakewharton.screenrecord.R.id.record_overlay_buttons) View buttonsView;
  @BindView(com.jakewharton.screenrecord.R.id.record_overlay_cancel) View cancelView;
  @BindView(com.jakewharton.screenrecord.R.id.record_overlay_start) View startView;
  @BindView(com.jakewharton.screenrecord.R.id.record_overlay_stop) View stopView;
  @BindView(com.jakewharton.screenrecord.R.id.record_overlay_recording) TextView recordingView;
...
//    this.showCountDown = showCountDown;
  ...
  @OnClick(com.jakewharton.screenrecord.R.id.record_overlay_cancel) void onCancelClicked() {
  ...
  @OnClick(com.jakewharton.screenrecord.R.id.record_overlay_start) void onStartClicked() {
